...
//			}
	...
	@Override
	public String createHost(Host host,HostInterface hostInterface,HostGroup hostgroup,Template template,String auth){
		String result = "";
		...
		if(host!=null){
			...
			if(host.getStatus()!=null&&!"".equals(host.getStatus().toString())){
			...
			JSONObject object = (JSONObject) create(create,auth);
...
//				}
	...
	public Object get(HostGetRequest get){
		...
		JSONObject rs =null;
		try {
			System.out.println("请求"+js.toJson(get));
