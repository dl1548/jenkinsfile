...
public class ApplicationServiceImpl implements IApplicationService {
    ...
    public Object get(ApplicationGetRequest get,String auth) {
        ...
        JSONObject rs = null;
        try {
         //   System.out.println("get:"+js.toJson(get));
    ...
    @Override
    public List<Application> getApplicationToBean(ApplicationGetRequest get,String auth) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    if (applicationObject.has("items")) {
                        ...
                        for (int k = 0; k < itemarray.length(); k++) {
                            ...
                            item.setType(itemObject.getInt("type"));
                            item.setHistory(itemObject.getInt("history"));
                            item.setLastns(itemObject.getInt("lastns"));
                            item.setLastclock(itemObject.getString("lastclock"));
    ...
    @Override
    public List<Application> getApplication(ApplicationGetRequest get,String auth) {
        List<Application> applications = null;
        JSONObject result = (JSONObject) this.get(get, auth);
        if (result.has("result")) {
            applications = new ArrayList<Application>();
 ...
 */
	...
	public Object delete(ApplicationDeleteRequest delete,String auth) {
		 Gson js = new Gson();
	        ...
	        JSONObject rs = null;
	        try {
	          //  System.out.println("get:"+js.toJson(delete));
