...
public class FormatData {
	...
	public static String API_URL ="http://192.168.1.200/zabbix/api_jsonrpc.php"; // API的连接，在接口中给它赋值
...
//					"time(0)}<", "time(0)}>", "time(0)}=", "time(0)}#", } };
	...
	public static double getDouble(String f){
		BigDecimal   b   =   new   BigDecimal(Double.valueOf(f));  
	...
	public static boolean getLikeByMap(Map<String, String>map,String keyLike){
	 ...
	 * @return
	 */
	public static String grouplistToString(List<UserGroup> list){
		String str="";
